            ...
            <div class="card-body">
                <form method="POST" action="{{ route('books.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <textarea id="description" rows="3" class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" name="description" value="{{ old('description') }}" autofocus></textarea>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="author" type="text" class="form-control{{ $errors->has('author') ? ' is-invalid' : '' }}" name="author" value="{{ old('author') }}" required autofocus>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="release_year" type="number" min="0" class="form-control{{ $errors->has('release_year') ? ' is-invalid' : '' }}" name="release_year" value="{{ old('release_year') }}" required autofocus>
